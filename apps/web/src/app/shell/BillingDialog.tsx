            ...
            <div className="space-y-5">
              ...
              {showError && (
                <Card className="flex flex-col items-center gap-4 p-8 text-center">
                  <span className="flex size-10 items-center justify-center rounded-xl bg-red-50 text-red-500 dark:bg-red-950/50 dark:text-red-400">
              ...
              {!isPending && !isError && data && plan && usage && (
                <div className="space-y-4">
                  {/* ── 1. Your Plan Card ──────────────────────────────── */}
                  <Card className="p-5 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 shadow-sm rounded-xl">
                    ...
                    <div className="mt-4 border-t border-zinc-100 dark:border-zinc-800 pt-3 text-xs text-zinc-600 dark:text-zinc-400">
                      {sub?.status === 'trialing' && (
                  ...
                  <Card className="p-5 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 shadow-sm rounded-xl">
                    ...
                    <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-zinc-100 dark:border-zinc-800 pt-4">
                      <div>
