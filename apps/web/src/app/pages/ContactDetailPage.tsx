        ...
        <Card className="divide-y divide-zinc-100">
          <div className="flex items-center gap-4 p-5">
            ...
            <div className="min-w-0">
              <p className="truncate text-lg font-semibold text-zinc-900">{contact.name}</p>
          ...
          <div className="space-y-4 p-5">
            ...
            <div>
              ...
              {contact.notes ? (
                <p className="mt-1 whitespace-pre-wrap text-sm leading-relaxed text-zinc-600">{contact.notes}</p>
              ) : (
