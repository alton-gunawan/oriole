...
export function PrivacyPolicyPage() {
  ...
  const sections = [
    { title: t('legal.ppSection1Title'), text: t('legal.ppSection1Text') },
    { title: t('legal.ppSection2Title'), text: t('legal.ppSection2Text') },
    { title: t('legal.ppSection3Title'), text: t('legal.ppSection3Text') },
    { title: t('legal.ppSection4Title'), text: t('legal.ppSection4Text') },
    { title: t('legal.ppSection5Title'), text: t('legal.ppSection5Text') },
    { title: t('legal.ppSection6Title'), text: t('legal.ppSection6Text') },
    { title: t('legal.ppSection7Title'), text: t('legal.ppSection7Text') },
  ];
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-8">
            ...
            <div className="flex items-center gap-2 text-amber-600 dark:text-amber-500 mb-2">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider">Oriole Privacy</span>
            </div>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-zinc-200 pt-6 dark:border-zinc-800 text-xs text-zinc-500 dark:text-zinc-400">
            ...
            <div className="flex items-center gap-4">
              <Link to="/user-agreement" className="hover:text-zinc-900 dark:hover:text-zinc-200 underline underline-offset-2">
